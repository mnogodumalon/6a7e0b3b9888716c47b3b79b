// Auto-generated. Per-entity form-enhancements config for "Dokumentenprüfung".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    'hochladedatum': { kind: 'today' },
    'pruefstatus': { kind: 'lookup', key: 'ausstehend', label: 'Ausstehend' },
  },
  computed: {},
};
