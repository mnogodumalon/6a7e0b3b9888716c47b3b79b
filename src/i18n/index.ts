...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Dokumentenprüfung",
    "apps": {
      "dokumentenpruefung": {
        "name": "Dokumentenprüfung",
        "app_id": "6a7e0b2e1c45ea49b73c3809",
        "fields": {
          ...
          "pruefkommentar": "Prüfkommentar",
          "prueferdatum": "Prüfdatum",
          "pruefer": "Prüfer"
        },
        "lookups": {
          "pruefstatus": {
            ...
            "nachbesserung_erforderlich": "Nachbesserung erforderlich"
          }
        }
      }
    }
    ...
    "apps": {
      "dokumentenpruefung": {
        ...
        "fields": {
          ...
          "dokument": "Document",
          "hochladedatum": "Upload Date",
          "pruefstatus": "Review Status",
          "pruefkommentar": "Review Comment",
          "prueferdatum": "Review Date",
          "pruefer": "Reviewer"
        },
        "lookups": {
          "pruefstatus": {
            ...
            "ausstehend": "Pending",
            "nachbesserung_erforderlich": "Revision Required"
          }
        }
      }
    }
